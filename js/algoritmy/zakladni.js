/**
 * Algoritmus „Základní (4 fáze)“ – výpočet návrhu směn.
 ...
 * API: objekt s { id, nazev, vypocet(data) }.
 */
(function (global) {
  'use strict';
  ...
  // Export algoritmu pro registr (API: id, nazev, vypocet)
  global.MSemenyAlgoritmusZakladni = {
    id: 'zakladni',
    nazev: 'Základní (4 fáze)',
    vypocet: vypocetSmen
  };

  // Helpery pro testy a facade (zpětná kompatibilita MSemenyVypocetSmen)
  global.MSemenyAlgoritmusZakladniHelpers = {
