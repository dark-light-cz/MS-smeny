# Plán implementace webové aplikace

Tento dokument popisuje vysokou úroveň plánu pro vývoj aplikace v editoru Cursor. Slouží k orientaci a k rozdělení práce na fáze a úkoly.
...
- Dílčí zadání dle CHECKLIST.md
- Vývoj po jednotlivých funkcích
- Po každé hotové funkci: revize dotazů, aktualizace dokumentace stavu
...
### Fáze 4: Publikace
- Výběr hostingu (až bude rozhodnuto)
- Nasazení a ověření

---

## Jak pracovat s plánem v Cursoru

1. **Checklist** (CHECKLIST.md) – drží přehled: co je hotové, co je třeba dodělat. Úkoly plníme po jednom nebo v logických blocích.
...
- **Čistý JavaScript** – logika, žádné frameworky
- **CSS** – styly

Repozitář a commit zprávy: **pouze česky**.
